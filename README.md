...
- **Insights**: Cohort barrier patterns, autonomy pulse (how many participants chose no contact), Week 3 watch, and extreme heat alerts based on the National Weather Service forecast.
...
- **Model Card**:
    ...
    Show in-app AI transparency: what the model uses, what it never touches, limitations, and the human-in-loop commitment.
